...
# Dependencies ----
source("./Time_Dim_Turbo_Region_para_setting_version5.R") # load timesteps, dim and Turbine
...
names(kites_metric) <- c(paste(rep("timestep_", timesteps), 1:5, sep =""),
                         paste(rep("killed_", timesteps), 1:5, sep =""))
